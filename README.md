...
- An Azure VM
- Python installed on the Azure VM

**Preparing Your Environment (On VM):**

1. **Install Python**: Download and install Python from the official Python website, ensuring it's added to your system's PATH.
2. **Install Required Libraries**: Open the Command Prompt and install necessary Azure libraries with:
...
2. **Identity**: In the left menu, find and select "Identity" under the "Settings" group.
